...
import screenShot04 from "../assets/images/my-projects/mc06.png"
import screenShot05 from "../assets/images/my-projects/mc04.png"
import screenShot06 from "../assets/images/my-projects/mc03.png"
  ...
  return (
    <div className='project-view-page-container'>
      ...
      <div className='project-links'>
        <a href='https://msingh17122000.github.io/macOS-Ventura-Simulator/' target="_blank"className='read-more'>Live Project {'>'}</a>
        <a href='https://github.com/msingh17122000/macOS-Ventura-Simulator' target="_blank"className='read-more'>GitHub Repository {'>'}</a>
      </div>
      <br /><br />
