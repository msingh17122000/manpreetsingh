  ...
  return (
    <div className='project-view-page-container'>
      ...
      <div className='project-links'>
        <a href='https://msingh17122000.github.io/iOS-16.2-Simulator/' target="_blank" rel="noreferrer" className='read-more'>Live Project {'>'}</a>
        <a href='https://github.com/msingh17122000/iOS-16.2-Simulator' target="_blank" rel="noreferrer" className='read-more'>GitHub Repository {'>'}</a>
      </div>
      <br /><br />
